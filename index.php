...
$city = "Peterborough";
$email = "dankackin@mail.ru";
$telephone = "+44 7949 457988";
$skills = [
    [
        'name' => 'Фотошоп',
        'percent' => 30,
...
$workexperience = [
    [
        ...
        'description' => 'Playing a key role in systems engineering activity for the development and deployment of new software based products.
        ...
        'work-period' => '2018 Mar - Current',
    ],
    [
        'job-position' => 'CAD Technician',
        'description' => 'Technical draughting competence is essential, as is the ability to supervise and train juniors to produce accurate, 
                          appropriate engineering drawings and models in an efficient and effective manner.',
        'work-period' => '2014 Apr - 2017 June',
    ],
    [
        'job-position' => 'Software Developer',  
        'description' => 'Building and enhancing web applications using the .NET framework
                          Innovating new features for existing software applications
                          Working with 3rd party solutions, APIs, Payment Processors, etc.',
        'work-period' => '2010 Dec - 2014 Jan',
    ],
];
?>
<!DOCTYPE html>
          ...
          <h2 class="w3-text-grey w3-padding-16"><i
              class="fa fa-suitcase fa-fw w3-margin-right w3-xxlarge w3-text-teal"></i>Work Experience</h2>
                <?php for ($i = 0; $i < count($workexperience); $i++):?>
                    <div class="w3-container">
                    <h5 class="w3-opacity"><b><?= $workexperience[$i]['job-position']?></b></h5>
                    <h6 class="w3-text-teal"><i class="fa fa-calendar fa-fw w3-margin-right"></i><?= $workexperience[$i]['work-period']?></h6>
